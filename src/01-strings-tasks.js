...
function getRectangleString(width, height) {
  ...
  for (let i = 0; i < height; i += 1) {
    if (i === 0) {
      if (width > 2) {
        result += fitstStrStart + firstStrMiddle.repeat(width - 2) + firstStrEnd;
      }
      if (width === 2) {
        result += fitstStrStart + firstStrEnd;
      }
    }
    if (i > 0 && i < height - 1) {
      if (width > 2) {
        result += midStrStart + midStrMiddle.repeat(width - 2) + midStrEnd;
      }
      if (width === 2) {
        result += midStrStart + midStrEnd;
      }
    }
    if (i === height - 1) {
      if (width > 2) {
        result += endStrStart + endStrMiddle.repeat(width - 2) + endStrEnd;
      }
      if (width === 2) {
        result += endStrStart + endStrEnd;
      }
    }
  }
  return result;
